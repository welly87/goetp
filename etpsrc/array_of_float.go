...
func DeserializeArrayOfFloat(r io.Reader) (*ArrayOfFloat, error) {
	return readArrayOfFloat(r)
}
...
func (r *ArrayOfFloat) Schema() string {
	return "{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"float\",\"type\":\"array\"}}],\"name\":\"ArrayOfFloat\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}"
}

func (r *ArrayOfFloat) Serialize(w io.Writer) error {
	return writeArrayOfFloat(r, w)
}
