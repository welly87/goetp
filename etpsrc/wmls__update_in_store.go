...
func DeserializeWMLS_UpdateInStore(r io.Reader) (*WMLS_UpdateInStore, error) {
	return readWMLS_UpdateInStore(r)
}

func NewWMLS_UpdateInStore() *WMLS_UpdateInStore {
	v := &WMLS_UpdateInStore{}

	return v
}

func (r *WMLS_UpdateInStore) Schema() string {
	return "{\"fields\":[{\"name\":\"WMLtypeIn\",\"type\":\"string\"},{\"name\":\"XMLin\",\"type\":\"string\"},{\"name\":\"OptionsIn\",\"type\":\"string\"},{\"name\":\"CapabilitiesIn\",\"type\":\"string\"}],\"messageType\":\"13\",\"name\":\"WMLS_UpdateInStore\",\"namespace\":\"Energistics.Protocol.WitsmlSoap\",\"protocol\":\"8\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *WMLS_UpdateInStore) Serialize(w io.Writer) error {
	return writeWMLS_UpdateInStore(r, w)
}
