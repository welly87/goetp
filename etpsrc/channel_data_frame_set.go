...
func DeserializeChannelDataFrameSet(r io.Reader) (*ChannelDataFrameSet, error) {
	return readChannelDataFrameSet(r)
}

func NewChannelDataFrameSet() *ChannelDataFrameSet {
	v := &ChannelDataFrameSet{
...
func (r *ChannelDataFrameSet) Schema() string {
	return "{\"fields\":[{\"name\":\"channels\",\"type\":{\"items\":\"long\",\"type\":\"array\"}},{\"name\":\"data\",\"type\":{\"items\":{\"fields\":[{\"name\":\"index\",\"type\":{\"items\":\"long\",\"type\":\"array\"}},{\"name\":\"data\",\"type\":{\"items\":{\"fields\":[{\"name\":\"item\",\"type\":[\"null\",\"double\",\"float\",\"int\",\"long\",\"string\",{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"double\",\"type\":\"array\"}}],\"name\":\"ArrayOfDouble\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"},\"boolean\",\"bytes\"]}],\"name\":\"DataValue\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"},\"type\":\"array\"}}],\"name\":\"DataFrame\",\"namespace\":\"Energistics.Datatypes.ChannelData\",\"type\":\"record\"},\"type\":\"array\"}}],\"messageType\":\"4\",\"name\":\"ChannelDataFrameSet\",\"namespace\":\"Energistics.Protocol.ChannelDataFrame\",\"protocol\":\"2\",\"protocolRoles\":\"producer,consumer\",\"senderRole\":\"producer\",\"type\":\"record\"}"
}

func (r *ChannelDataFrameSet) Serialize(w io.Writer) error {
	return writeChannelDataFrameSet(r, w)
}
