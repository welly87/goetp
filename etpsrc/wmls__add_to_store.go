...
func DeserializeWMLS_AddToStore(r io.Reader) (*WMLS_AddToStore, error) {
	return readWMLS_AddToStore(r)
}
...
func (r *WMLS_AddToStore) Schema() string {
	return "{\"fields\":[{\"name\":\"WMLtypeIn\",\"type\":\"string\"},{\"name\":\"XMLin\",\"type\":\"string\"},{\"name\":\"OptionsIn\",\"type\":\"string\"},{\"name\":\"CapabilitiesIn\",\"type\":\"string\"}],\"messageType\":\"1\",\"name\":\"WMLS_AddToStore\",\"namespace\":\"Energistics.Protocol.WitsmlSoap\",\"protocol\":\"8\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *WMLS_AddToStore) Serialize(w io.Writer) error {
	return writeWMLS_AddToStore(r, w)
}
