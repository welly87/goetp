...
func DeserializeServerCapabilities(r io.Reader) (*ServerCapabilities, error) {
	return readServerCapabilities(r)
}
...
func (r *ServerCapabilities) Schema() string {
	return "{\"fields\":[{\"name\":\"applicationName\",\"type\":\"string\"},{\"name\":\"applicationVersion\",\"type\":\"string\"},{\"name\":\"supportedProtocols\",\"type\":{\"items\":{\"fields\":[{\"name\":\"protocol\",\"type\":\"int\"},{\"name\":\"protocolVersion\",\"type\":{\"fields\":[{\"name\":\"major\",\"type\":\"int\"},{\"name\":\"minor\",\"type\":\"int\"},{\"name\":\"revision\",\"type\":\"int\"},{\"name\":\"patch\",\"type\":\"int\"}],\"name\":\"Version\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}},{\"name\":\"role\",\"type\":\"string\"},{\"name\":\"protocolCapabilities\",\"type\":{\"type\":\"map\",\"values\":{\"fields\":[{\"name\":\"item\",\"type\":[\"null\",\"double\",\"float\",\"int\",\"long\",\"string\",{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"double\",\"type\":\"array\"}}],\"name\":\"ArrayOfDouble\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"},\"boolean\",\"bytes\"]}],\"name\":\"DataValue\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}}}],\"name\":\"SupportedProtocol\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"},\"type\":\"array\"}},{\"name\":\"supportedObjects\",\"type\":{\"items\":\"string\",\"type\":\"array\"}},{\"name\":\"contactInformation\",\"type\":{\"fields\":[{\"name\":\"organizationName\",\"type\":[\"null\",\"string\"]},{\"name\":\"contactName\",\"type\":[\"null\",\"string\"]},{\"name\":\"contactPhone\",\"type\":[\"null\",\"string\"]},{\"name\":\"contactEmail\",\"type\":[\"null\",\"string\"]}],\"name\":\"Contact\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}},{\"name\":\"supportedEncodings\",\"type\":\"string\"}],\"name\":\"ServerCapabilities\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}"
}

func (r *ServerCapabilities) Serialize(w io.Writer) error {
	return writeServerCapabilities(r, w)
}
