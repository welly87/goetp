...
func DeserializeStart(r io.Reader) (*Start, error) {
	return readStart(r)
}
...
func (r *Start) Schema() string {
	return "{\"fields\":[{\"name\":\"maxMessageRate\",\"type\":\"int\"},{\"name\":\"maxDataItems\",\"type\":\"int\"}],\"messageType\":\"0\",\"name\":\"Start\",\"namespace\":\"Energistics.Protocol.ChannelStreaming\",\"protocol\":\"1\",\"protocolRoles\":\"producer,consumer\",\"senderRole\":\"consumer\",\"type\":\"record\"}"
}

func (r *Start) Serialize(w io.Writer) error {
	return writeStart(r, w)
}
