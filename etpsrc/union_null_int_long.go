...
type UnionNullIntLong struct {
	Null      interface{}
	Int       int32
	Long      int64
	UnionType UnionNullIntLongTypeEnum
}

type UnionNullIntLongTypeEnum int

const (
	UnionNullIntLongTypeEnumNull UnionNullIntLongTypeEnum = 0
	UnionNullIntLongTypeEnumInt  UnionNullIntLongTypeEnum = 1
	UnionNullIntLongTypeEnumLong UnionNullIntLongTypeEnum = 2
)
