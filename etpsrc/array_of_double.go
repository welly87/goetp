...
func DeserializeArrayOfDouble(r io.Reader) (*ArrayOfDouble, error) {
	return readArrayOfDouble(r)
}
...
func (r *ArrayOfDouble) Schema() string {
	return "{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"double\",\"type\":\"array\"}}],\"name\":\"ArrayOfDouble\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}"
}

func (r *ArrayOfDouble) Serialize(w io.Writer) error {
	return writeArrayOfDouble(r, w)
}
