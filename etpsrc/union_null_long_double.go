...
type UnionNullLongDouble struct {
	Null      interface{}
	Long      int64
	Double    float64
	UnionType UnionNullLongDoubleTypeEnum
}

type UnionNullLongDoubleTypeEnum int

const (
	UnionNullLongDoubleTypeEnumNull   UnionNullLongDoubleTypeEnum = 0
	UnionNullLongDoubleTypeEnumLong   UnionNullLongDoubleTypeEnum = 1
	UnionNullLongDoubleTypeEnumDouble UnionNullLongDoubleTypeEnum = 2
)
