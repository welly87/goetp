...
func DeserializeGetResources(r io.Reader) (*GetResources, error) {
	return readGetResources(r)
}
...
func (r *GetResources) Schema() string {
	return "{\"fields\":[{\"name\":\"uri\",\"type\":\"string\"}],\"messageType\":\"1\",\"name\":\"GetResources\",\"namespace\":\"Energistics.Protocol.Discovery\",\"protocol\":\"3\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *GetResources) Serialize(w io.Writer) error {
	return writeGetResources(r, w)
}
