...
func DeserializeDataAttribute(r io.Reader) (*DataAttribute, error) {
	return readDataAttribute(r)
}

func NewDataAttribute() *DataAttribute {
	v := &DataAttribute{
		AttributeValue: NewDataValue(),
	}

	return v
}

func (r *DataAttribute) Schema() string {
	return "{\"fields\":[{\"name\":\"attributeId\",\"type\":\"int\"},{\"name\":\"attributeValue\",\"type\":{\"fields\":[{\"name\":\"item\",\"type\":[\"null\",\"double\",\"float\",\"int\",\"long\",\"string\",{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"double\",\"type\":\"array\"}}],\"name\":\"ArrayOfDouble\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"},\"boolean\",\"bytes\"]}],\"name\":\"DataValue\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}}],\"name\":\"DataAttribute\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}"
}

func (r *DataAttribute) Serialize(w io.Writer) error {
	return writeDataAttribute(r, w)
}
