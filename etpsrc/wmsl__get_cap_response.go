...
func DeserializeWMSL_GetCapResponse(r io.Reader) (*WMSL_GetCapResponse, error) {
	return readWMSL_GetCapResponse(r)
}

func NewWMSL_GetCapResponse() *WMSL_GetCapResponse {
	v := &WMSL_GetCapResponse{}

	return v
}

func (r *WMSL_GetCapResponse) Schema() string {
	return "{\"fields\":[{\"name\":\"Result\",\"type\":\"int\"},{\"name\":\"CapabilitiesOut\",\"type\":\"string\"},{\"name\":\"SuppMsgOut\",\"type\":\"string\"}],\"messageType\":\"8\",\"name\":\"WMSL_GetCapResponse\",\"namespace\":\"Energistics.Protocol.WitsmlSoap\",\"protocol\":\"8\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"store\",\"type\":\"record\"}"
}

func (r *WMSL_GetCapResponse) Serialize(w io.Writer) error {
	return writeWMSL_GetCapResponse(r, w)
}
