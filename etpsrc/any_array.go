...
type AnyArray struct {
	Item UnionNullArrayOfBooleanBytesArrayOfIntArrayOfLongArrayOfFloatArrayOfDouble
}

func DeserializeAnyArray(r io.Reader) (*AnyArray, error) {
