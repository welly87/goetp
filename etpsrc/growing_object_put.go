...
func DeserializeGrowingObjectPut(r io.Reader) (*GrowingObjectPut, error) {
	return readGrowingObjectPut(r)
}
...
func (r *GrowingObjectPut) Schema() string {
	return "{\"fields\":[{\"name\":\"uri\",\"type\":\"string\"},{\"name\":\"contentType\",\"type\":\"string\"},{\"name\":\"contentEncoding\",\"type\":\"string\"},{\"name\":\"data\",\"type\":\"bytes\"}],\"messageType\":\"5\",\"name\":\"GrowingObjectPut\",\"namespace\":\"Energistics.Protocol.GrowingObject\",\"protocol\":\"6\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *GrowingObjectPut) Serialize(w io.Writer) error {
	return writeGrowingObjectPut(r, w)
}
