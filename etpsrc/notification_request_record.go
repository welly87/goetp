...
func DeserializeNotificationRequestRecord(r io.Reader) (*NotificationRequestRecord, error) {
	return readNotificationRequestRecord(r)
}

func NewNotificationRequestRecord() *NotificationRequestRecord {
	v := &NotificationRequestRecord{
...
func (r *NotificationRequestRecord) Schema() string {
	return "{\"fields\":[{\"name\":\"uri\",\"type\":\"string\"},{\"name\":\"uuid\",\"type\":\"string\"},{\"name\":\"includeObjectData\",\"type\":\"boolean\"},{\"name\":\"startTime\",\"type\":\"long\"},{\"name\":\"objectTypes\",\"type\":{\"items\":\"string\",\"type\":\"array\"}}],\"name\":\"NotificationRequestRecord\",\"namespace\":\"Energistics.Datatypes.Object\",\"type\":\"record\"}"
}

func (r *NotificationRequestRecord) Serialize(w io.Writer) error {
	return writeNotificationRequestRecord(r, w)
}
