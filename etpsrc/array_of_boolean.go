...
func DeserializeArrayOfBoolean(r io.Reader) (*ArrayOfBoolean, error) {
	return readArrayOfBoolean(r)
}
...
func (r *ArrayOfBoolean) Schema() string {
	return "{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"boolean\",\"type\":\"array\"}}],\"name\":\"ArrayOfBoolean\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}"
}

func (r *ArrayOfBoolean) Serialize(w io.Writer) error {
	return writeArrayOfBoolean(r, w)
}
