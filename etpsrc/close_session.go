...
type CloseSession struct {
	Reason UnionNullString
}

func DeserializeCloseSession(r io.Reader) (*CloseSession, error) {
	return readCloseSession(r)
}
...
func (r *CloseSession) Schema() string {
	return "{\"fields\":[{\"name\":\"reason\",\"type\":[\"null\",\"string\"]}],\"messageType\":\"5\",\"name\":\"CloseSession\",\"namespace\":\"Energistics.Protocol.Core\",\"protocol\":\"0\",\"protocolRoles\":\"client,server\",\"senderRole\":\"client,server\",\"type\":\"record\"}"
}

func (r *CloseSession) Serialize(w io.Writer) error {
	return writeCloseSession(r, w)
}
