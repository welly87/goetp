...
type ChannelRemove struct {
	ChannelId    int64
	RemoveReason UnionNullString
}

func DeserializeChannelRemove(r io.Reader) (*ChannelRemove, error) {
	return readChannelRemove(r)
}
...
func (r *ChannelRemove) Schema() string {
	return "{\"fields\":[{\"name\":\"channelId\",\"type\":\"long\"},{\"name\":\"removeReason\",\"type\":[\"null\",\"string\"]}],\"messageType\":\"8\",\"name\":\"ChannelRemove\",\"namespace\":\"Energistics.Protocol.ChannelStreaming\",\"protocol\":\"1\",\"protocolRoles\":\"producer,consumer\",\"senderRole\":\"producer\",\"type\":\"record\"}"
}

func (r *ChannelRemove) Serialize(w io.Writer) error {
	return writeChannelRemove(r, w)
}
