...
func DeserializeChannelStatusChange(r io.Reader) (*ChannelStatusChange, error) {
	return readChannelStatusChange(r)
}

func NewChannelStatusChange() *ChannelStatusChange {
	v := &ChannelStatusChange{}

	return v
}

func (r *ChannelStatusChange) Schema() string {
	return "{\"fields\":[{\"name\":\"channelId\",\"type\":\"long\"},{\"name\":\"status\",\"type\":{\"name\":\"ChannelStatuses\",\"namespace\":\"Energistics.Datatypes.ChannelData\",\"symbols\":[\"Active\",\"Inactive\",\"Closed\"],\"type\":\"enum\"}}],\"messageType\":\"10\",\"name\":\"ChannelStatusChange\",\"namespace\":\"Energistics.Protocol.ChannelStreaming\",\"protocol\":\"1\",\"protocolRoles\":\"producer,consumer\",\"senderRole\":\"producer\",\"type\":\"record\"}"
}

func (r *ChannelStatusChange) Serialize(w io.Writer) error {
	return writeChannelStatusChange(r, w)
}
