...
func DeserializeWMSL_UpdateInStoreResponse(r io.Reader) (*WMSL_UpdateInStoreResponse, error) {
	return readWMSL_UpdateInStoreResponse(r)
}

func NewWMSL_UpdateInStoreResponse() *WMSL_UpdateInStoreResponse {
	v := &WMSL_UpdateInStoreResponse{}

	return v
}

func (r *WMSL_UpdateInStoreResponse) Schema() string {
	return "{\"fields\":[{\"name\":\"Result\",\"type\":\"int\"},{\"name\":\"SuppMsgOut\",\"type\":\"string\"}],\"messageType\":\"14\",\"name\":\"WMSL_UpdateInStoreResponse\",\"namespace\":\"Energistics.Protocol.WitsmlSoap\",\"protocol\":\"8\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"store\",\"type\":\"record\"}"
}

func (r *WMSL_UpdateInStoreResponse) Serialize(w io.Writer) error {
	return writeWMSL_UpdateInStoreResponse(r, w)
}
