...
func DeserializeGetDataArray(r io.Reader) (*GetDataArray, error) {
	return readGetDataArray(r)
}
...
func (r *GetDataArray) Schema() string {
	return "{\"fields\":[{\"name\":\"uri\",\"type\":\"string\"}],\"messageType\":\"2\",\"name\":\"GetDataArray\",\"namespace\":\"Energistics.Protocol.DataArray\",\"protocol\":\"7\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *GetDataArray) Serialize(w io.Writer) error {
	return writeGetDataArray(r, w)
}
