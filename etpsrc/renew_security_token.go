...
func DeserializeRenewSecurityToken(r io.Reader) (*RenewSecurityToken, error) {
	return readRenewSecurityToken(r)
}

func NewRenewSecurityToken() *RenewSecurityToken {
	v := &RenewSecurityToken{}

	return v
}

func (r *RenewSecurityToken) Schema() string {
	return "{\"fields\":[{\"name\":\"token\",\"type\":\"string\"}],\"messageType\":\"6\",\"name\":\"RenewSecurityToken\",\"namespace\":\"Energistics.Protocol.Core\",\"protocol\":\"0\",\"protocolRoles\":\"client,server\",\"senderRole\":\"client\",\"type\":\"record\"}"
}

func (r *RenewSecurityToken) Serialize(w io.Writer) error {
	return writeRenewSecurityToken(r, w)
}
