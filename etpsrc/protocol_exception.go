...
func DeserializeProtocolException(r io.Reader) (*ProtocolException, error) {
	return readProtocolException(r)
}
...
func (r *ProtocolException) Schema() string {
	return "{\"fields\":[{\"name\":\"errorCode\",\"type\":\"int\"},{\"name\":\"errorMessage\",\"type\":\"string\"}],\"messageType\":\"1000\",\"name\":\"ProtocolException\",\"namespace\":\"Energistics.Protocol.Core\",\"protocol\":\"0\",\"protocolRoles\":\"client,server\",\"senderRole\":\"*\",\"type\":\"record\"}"
}

func (r *ProtocolException) Serialize(w io.Writer) error {
	return writeProtocolException(r, w)
}
