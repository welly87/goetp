...
func DeserializeDataItem(r io.Reader) (*DataItem, error) {
	return readDataItem(r)
}
...
func (r *DataItem) Serialize(w io.Writer) error {
	return writeDataItem(r, w)
}
