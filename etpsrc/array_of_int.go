...
func DeserializeArrayOfInt(r io.Reader) (*ArrayOfInt, error) {
	return readArrayOfInt(r)
}
...
func (r *ArrayOfInt) Schema() string {
	return "{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"int\",\"type\":\"array\"}}],\"name\":\"ArrayOfInt\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}"
}

func (r *ArrayOfInt) Serialize(w io.Writer) error {
	return writeArrayOfInt(r, w)
}
