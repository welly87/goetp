...
func DeserializeChannelStreamingInfo(r io.Reader) (*ChannelStreamingInfo, error) {
	return readChannelStreamingInfo(r)
}

func NewChannelStreamingInfo() *ChannelStreamingInfo {
	v := &ChannelStreamingInfo{
		StartIndex: NewStreamingStartIndex(),
	}

	return v
}

func (r *ChannelStreamingInfo) Schema() string {
...
func (r *ChannelStreamingInfo) Serialize(w io.Writer) error {
	return writeChannelStreamingInfo(r, w)
}
