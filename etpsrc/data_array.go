...
func DeserializeDataArray(r io.Reader) (*DataArray, error) {
	return readDataArray(r)
}
...
func (r *DataArray) Schema() string {
	return "{\"fields\":[{\"name\":\"dimensions\",\"type\":{\"items\":\"long\",\"type\":\"array\"}},{\"name\":\"data\",\"type\":{\"fields\":[{\"name\":\"item\",\"type\":[\"null\",{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"boolean\",\"type\":\"array\"}}],\"name\":\"ArrayOfBoolean\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"},\"bytes\",{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"int\",\"type\":\"array\"}}],\"name\":\"ArrayOfInt\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"},{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"long\",\"type\":\"array\"}}],\"name\":\"ArrayOfLong\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"},{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"float\",\"type\":\"array\"}}],\"name\":\"ArrayOfFloat\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"},{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"double\",\"type\":\"array\"}}],\"name\":\"ArrayOfDouble\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}]}],\"name\":\"AnyArray\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}}],\"messageType\":\"1\",\"name\":\"DataArray\",\"namespace\":\"Energistics.Protocol.DataArray\",\"protocol\":\"7\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"store\",\"type\":\"record\"}"
}

func (r *DataArray) Serialize(w io.Writer) error {
	return writeDataArray(r, w)
}
