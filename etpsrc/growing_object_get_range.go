...
func DeserializeGrowingObjectGetRange(r io.Reader) (*GrowingObjectGetRange, error) {
	return readGrowingObjectGetRange(r)
}

func NewGrowingObjectGetRange() *GrowingObjectGetRange {
	v := &GrowingObjectGetRange{
...
func (r *GrowingObjectGetRange) Schema() string {
	return "{\"fields\":[{\"name\":\"uri\",\"type\":\"string\"},{\"name\":\"startIndex\",\"type\":{\"fields\":[{\"name\":\"item\",\"type\":[\"null\",\"long\",\"double\"]}],\"name\":\"GrowingObjectIndex\",\"namespace\":\"Energistics.Datatypes.Object\",\"type\":\"record\"}},{\"name\":\"endIndex\",\"type\":\"Energistics.Datatypes.Object.GrowingObjectIndex\"},{\"name\":\"uom\",\"type\":\"string\"},{\"name\":\"depthDatum\",\"type\":\"string\"}],\"messageType\":\"4\",\"name\":\"GrowingObjectGetRange\",\"namespace\":\"Energistics.Protocol.GrowingObject\",\"protocol\":\"6\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *GrowingObjectGetRange) Serialize(w io.Writer) error {
	return writeGrowingObjectGetRange(r, w)
}
