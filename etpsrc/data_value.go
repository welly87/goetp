...
type DataValue struct {
	Item UnionNullDoubleFloatIntLongStringArrayOfDoubleBoolBytes
}

func DeserializeDataValue(r io.Reader) (*DataValue, error) {
...
func (r *DataValue) Schema() string {
	return "{\"fields\":[{\"name\":\"item\",\"type\":[\"null\",\"double\",\"float\",\"int\",\"long\",\"string\",{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"double\",\"type\":\"array\"}}],\"name\":\"ArrayOfDouble\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"},\"boolean\",\"bytes\"]}],\"name\":\"DataValue\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}"
}

func (r *DataValue) Serialize(w io.Writer) error {
	return writeDataValue(r, w)
}
