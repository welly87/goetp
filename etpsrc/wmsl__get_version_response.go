...
func DeserializeWMSL_GetVersionResponse(r io.Reader) (*WMSL_GetVersionResponse, error) {
	return readWMSL_GetVersionResponse(r)
}

func NewWMSL_GetVersionResponse() *WMSL_GetVersionResponse {
	v := &WMSL_GetVersionResponse{}

	return v
}

func (r *WMSL_GetVersionResponse) Schema() string {
	return "{\"fields\":[{\"name\":\"Result\",\"type\":\"string\"}],\"messageType\":\"12\",\"name\":\"WMSL_GetVersionResponse\",\"namespace\":\"Energistics.Protocol.WitsmlSoap\",\"protocol\":\"8\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"store\",\"type\":\"record\"}"
}

func (r *WMSL_GetVersionResponse) Serialize(w io.Writer) error {
	return writeWMSL_GetVersionResponse(r, w)
}
