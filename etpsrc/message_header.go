...
func (r *MessageHeader) Schema() string {
	return "{\"fields\":[{\"name\":\"protocol\",\"type\":\"int\"},{\"name\":\"messageType\",\"type\":\"int\"},{\"name\":\"correlationId\",\"type\":\"long\"},{\"name\":\"messageId\",\"type\":\"long\"},{\"name\":\"messageFlags\",\"type\":\"int\"}],\"name\":\"MessageHeader\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}"
}
