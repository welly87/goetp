...
func DeserializeWMLS_GetFromStore(r io.Reader) (*WMLS_GetFromStore, error) {
	return readWMLS_GetFromStore(r)
}
...
func (r *WMLS_GetFromStore) Schema() string {
	return "{\"fields\":[{\"name\":\"WMLtypeIn\",\"type\":\"string\"},{\"name\":\"XMLin\",\"type\":\"string\"},{\"name\":\"OptionsIn\",\"type\":\"string\"},{\"name\":\"CapabilitiesIn\",\"type\":\"string\"}],\"messageType\":\"9\",\"name\":\"WMLS_GetFromStore\",\"namespace\":\"Energistics.Protocol.WitsmlSoap\",\"protocol\":\"8\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *WMLS_GetFromStore) Serialize(w io.Writer) error {
	return writeWMLS_GetFromStore(r, w)
}
