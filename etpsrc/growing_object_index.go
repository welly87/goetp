...
type GrowingObjectIndex struct {
	Item UnionNullLongDouble
}

func DeserializeGrowingObjectIndex(r io.Reader) (*GrowingObjectIndex, error) {
	return readGrowingObjectIndex(r)
}

func NewGrowingObjectIndex() *GrowingObjectIndex {
	v := &GrowingObjectIndex{}

	return v
}

func (r *GrowingObjectIndex) Schema() string {
	return "{\"fields\":[{\"name\":\"item\",\"type\":[\"null\",\"long\",\"double\"]}],\"name\":\"GrowingObjectIndex\",\"namespace\":\"Energistics.Datatypes.Object\",\"type\":\"record\"}"
}

func (r *GrowingObjectIndex) Serialize(w io.Writer) error {
	return writeGrowingObjectIndex(r, w)
}
