...
func DeserializeWMSL_DeleteFromStoreResponse(r io.Reader) (*WMSL_DeleteFromStoreResponse, error) {
	return readWMSL_DeleteFromStoreResponse(r)
}

func NewWMSL_DeleteFromStoreResponse() *WMSL_DeleteFromStoreResponse {
	v := &WMSL_DeleteFromStoreResponse{}

	return v
}

func (r *WMSL_DeleteFromStoreResponse) Schema() string {
	return "{\"fields\":[{\"name\":\"Result\",\"type\":\"int\"},{\"name\":\"SuppMsgOut\",\"type\":\"string\"}],\"messageType\":\"4\",\"name\":\"WMSL_DeleteFromStoreResponse\",\"namespace\":\"Energistics.Protocol.WitsmlSoap\",\"protocol\":\"8\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"store\",\"type\":\"record\"}"
}

func (r *WMSL_DeleteFromStoreResponse) Serialize(w io.Writer) error {
	return writeWMSL_DeleteFromStoreResponse(r, w)
}
