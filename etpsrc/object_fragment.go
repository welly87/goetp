...
func DeserializeObjectFragment(r io.Reader) (*ObjectFragment, error) {
	return readObjectFragment(r)
}
...
func (r *ObjectFragment) Schema() string {
	return "{\"fields\":[{\"name\":\"uri\",\"type\":\"string\"},{\"name\":\"contentType\",\"type\":\"string\"},{\"name\":\"contentEncoding\",\"type\":\"string\"},{\"name\":\"data\",\"type\":\"bytes\"}],\"messageType\":\"6\",\"name\":\"ObjectFragment\",\"namespace\":\"Energistics.Protocol.GrowingObject\",\"protocol\":\"6\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"store\",\"type\":\"record\"}"
}

func (r *ObjectFragment) Serialize(w io.Writer) error {
	return writeObjectFragment(r, w)
}
