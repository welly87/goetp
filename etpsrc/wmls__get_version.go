...
func DeserializeWMLS_GetVersion(r io.Reader) (*WMLS_GetVersion, error) {
	return readWMLS_GetVersion(r)
}
...
func (r *WMLS_GetVersion) Schema() string {
	return "{\"fields\":[],\"messageType\":\"11\",\"name\":\"WMLS_GetVersion\",\"namespace\":\"Energistics.Protocol.WitsmlSoap\",\"protocol\":\"8\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *WMLS_GetVersion) Serialize(w io.Writer) error {
	return writeWMLS_GetVersion(r, w)
}
