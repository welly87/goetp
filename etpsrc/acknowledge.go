...
func DeserializeAcknowledge(r io.Reader) (*Acknowledge, error) {
	return readAcknowledge(r)
}
...
func (r *Acknowledge) Schema() string {
	return "{\"fields\":[],\"messageType\":\"1001\",\"name\":\"Acknowledge\",\"namespace\":\"Energistics.Protocol.Core\",\"protocol\":\"0\",\"protocolRoles\":\"client,server\",\"senderRole\":\"*\",\"type\":\"record\"}"
}

func (r *Acknowledge) Serialize(w io.Writer) error {
	return writeAcknowledge(r, w)
}
