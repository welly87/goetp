...
func DeserializeWMSL_GetBaseMsgResponse(r io.Reader) (*WMSL_GetBaseMsgResponse, error) {
	return readWMSL_GetBaseMsgResponse(r)
}

func NewWMSL_GetBaseMsgResponse() *WMSL_GetBaseMsgResponse {
	v := &WMSL_GetBaseMsgResponse{}

	return v
}

func (r *WMSL_GetBaseMsgResponse) Schema() string {
	return "{\"fields\":[{\"name\":\"Result\",\"type\":\"string\"}],\"messageType\":\"6\",\"name\":\"WMSL_GetBaseMsgResponse\",\"namespace\":\"Energistics.Protocol.WitsmlSoap\",\"protocol\":\"8\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"store\",\"type\":\"record\"}"
}

func (r *WMSL_GetBaseMsgResponse) Serialize(w io.Writer) error {
	return writeWMSL_GetBaseMsgResponse(r, w)
}
