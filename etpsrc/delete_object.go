...
func DeserializeDeleteObject(r io.Reader) (*DeleteObject, error) {
	return readDeleteObject(r)
}
...
func (r *DeleteObject) Schema() string {
	return "{\"fields\":[{\"name\":\"uri\",\"type\":\"string\"}],\"messageType\":\"3\",\"name\":\"DeleteObject\",\"namespace\":\"Energistics.Protocol.Store\",\"protocol\":\"4\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *DeleteObject) Serialize(w io.Writer) error {
	return writeDeleteObject(r, w)
}
