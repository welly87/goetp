...
func DeserializeGrowingObjectGet(r io.Reader) (*GrowingObjectGet, error) {
	return readGrowingObjectGet(r)
}
...
func (r *GrowingObjectGet) Schema() string {
	return "{\"fields\":[{\"name\":\"uri\",\"type\":\"string\"},{\"name\":\"uid\",\"type\":\"string\"}],\"messageType\":\"3\",\"name\":\"GrowingObjectGet\",\"namespace\":\"Energistics.Protocol.GrowingObject\",\"protocol\":\"6\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *GrowingObjectGet) Serialize(w io.Writer) error {
	return writeGrowingObjectGet(r, w)
}
