...
type RequestChannelData struct {
	Uri       string
	FromIndex UnionNullLong
	ToIndex   UnionNullLong
}

func DeserializeRequestChannelData(r io.Reader) (*RequestChannelData, error) {
	return readRequestChannelData(r)
}

func NewRequestChannelData() *RequestChannelData {
	v := &RequestChannelData{}

	return v
}

func (r *RequestChannelData) Schema() string {
	return "{\"fields\":[{\"name\":\"uri\",\"type\":\"string\"},{\"name\":\"fromIndex\",\"type\":[\"null\",\"long\"]},{\"name\":\"toIndex\",\"type\":[\"null\",\"long\"]}],\"messageType\":\"1\",\"name\":\"RequestChannelData\",\"namespace\":\"Energistics.Protocol.ChannelDataFrame\",\"protocol\":\"2\",\"protocolRoles\":\"producer,consumer\",\"senderRole\":\"consumer\",\"type\":\"record\"}"
}

func (r *RequestChannelData) Serialize(w io.Writer) error {
	return writeRequestChannelData(r, w)
}
