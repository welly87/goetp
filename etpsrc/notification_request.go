...
func DeserializeNotificationRequest(r io.Reader) (*NotificationRequest, error) {
	return readNotificationRequest(r)
}

func NewNotificationRequest() *NotificationRequest {
	v := &NotificationRequest{
		Request: NewNotificationRequestRecord(),
	}

	return v
}

func (r *NotificationRequest) Schema() string {
	return "{\"fields\":[{\"name\":\"request\",\"type\":{\"fields\":[{\"name\":\"uri\",\"type\":\"string\"},{\"name\":\"uuid\",\"type\":\"string\"},{\"name\":\"includeObjectData\",\"type\":\"boolean\"},{\"name\":\"startTime\",\"type\":\"long\"},{\"name\":\"objectTypes\",\"type\":{\"items\":\"string\",\"type\":\"array\"}}],\"name\":\"NotificationRequestRecord\",\"namespace\":\"Energistics.Datatypes.Object\",\"type\":\"record\"}}],\"messageType\":\"1\",\"name\":\"NotificationRequest\",\"namespace\":\"Energistics.Protocol.StoreNotification\",\"protocol\":\"5\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *NotificationRequest) Serialize(w io.Writer) error {
	return writeNotificationRequest(r, w)
}
