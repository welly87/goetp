...
func DeserializeGrowingObjectDelete(r io.Reader) (*GrowingObjectDelete, error) {
	return readGrowingObjectDelete(r)
}

func NewGrowingObjectDelete() *GrowingObjectDelete {
	v := &GrowingObjectDelete{}

	return v
}

func (r *GrowingObjectDelete) Schema() string {
	return "{\"fields\":[{\"name\":\"uri\",\"type\":\"string\"},{\"name\":\"uid\",\"type\":\"string\"}],\"messageType\":\"1\",\"name\":\"GrowingObjectDelete\",\"namespace\":\"Energistics.Protocol.GrowingObject\",\"protocol\":\"6\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *GrowingObjectDelete) Serialize(w io.Writer) error {
	return writeGrowingObjectDelete(r, w)
}
