...
type UnionNullDataObject struct {
	Null       interface{}
	DataObject *DataObject
	UnionType  UnionNullDataObjectTypeEnum
}

type UnionNullDataObjectTypeEnum int

const (
	UnionNullDataObjectTypeEnumNull       UnionNullDataObjectTypeEnum = 0
	UnionNullDataObjectTypeEnumDataObject UnionNullDataObjectTypeEnum = 1
)
