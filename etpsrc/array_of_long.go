...
func DeserializeArrayOfLong(r io.Reader) (*ArrayOfLong, error) {
	return readArrayOfLong(r)
}
...
func (r *ArrayOfLong) Schema() string {
	return "{\"fields\":[{\"name\":\"values\",\"type\":{\"items\":\"long\",\"type\":\"array\"}}],\"name\":\"ArrayOfLong\",\"namespace\":\"Energistics.Datatypes\",\"type\":\"record\"}"
}

func (r *ArrayOfLong) Serialize(w io.Writer) error {
	return writeArrayOfLong(r, w)
}
