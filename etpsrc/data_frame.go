...
func DeserializeDataFrame(r io.Reader) (*DataFrame, error) {
...
func (r *DataFrame) Schema() string {
...
func (r *DataFrame) Serialize(w io.Writer) error {
	return writeDataFrame(r, w)
}
