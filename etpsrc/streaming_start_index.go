...
type StreamingStartIndex struct {
	Item UnionNullIntLong
}

func DeserializeStreamingStartIndex(r io.Reader) (*StreamingStartIndex, error) {
	return readStreamingStartIndex(r)
}

func NewStreamingStartIndex() *StreamingStartIndex {
	v := &StreamingStartIndex{}

	return v
}

func (r *StreamingStartIndex) Schema() string {
	return "{\"fields\":[{\"name\":\"item\",\"type\":[\"null\",\"int\",\"long\"]}],\"name\":\"StreamingStartIndex\",\"namespace\":\"Energistics.Datatypes.ChannelData\",\"type\":\"record\"}"
}

func (r *StreamingStartIndex) Serialize(w io.Writer) error {
	return writeStreamingStartIndex(r, w)
}
