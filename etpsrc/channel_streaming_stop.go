...
func DeserializeChannelStreamingStop(r io.Reader) (*ChannelStreamingStop, error) {
	return readChannelStreamingStop(r)
}

func NewChannelStreamingStop() *ChannelStreamingStop {
	v := &ChannelStreamingStop{
...
func (r *ChannelStreamingStop) Schema() string {
	return "{\"fields\":[{\"name\":\"channels\",\"type\":{\"items\":\"long\",\"type\":\"array\"}}],\"messageType\":\"5\",\"name\":\"ChannelStreamingStop\",\"namespace\":\"Energistics.Protocol.ChannelStreaming\",\"protocol\":\"1\",\"protocolRoles\":\"producer,consumer\",\"senderRole\":\"consumer\",\"type\":\"record\"}"
}

func (r *ChannelStreamingStop) Serialize(w io.Writer) error {
	return writeChannelStreamingStop(r, w)
}
