...
func DeserializeWMLS_GetBaseMsg(r io.Reader) (*WMLS_GetBaseMsg, error) {
	return readWMLS_GetBaseMsg(r)
}
...
func (r *WMLS_GetBaseMsg) Schema() string {
	return "{\"fields\":[{\"name\":\"ReturnValueIn\",\"type\":\"int\"}],\"messageType\":\"5\",\"name\":\"WMLS_GetBaseMsg\",\"namespace\":\"Energistics.Protocol.WitsmlSoap\",\"protocol\":\"8\",\"protocolRoles\":\"store,customer\",\"senderRole\":\"customer\",\"type\":\"record\"}"
}

func (r *WMLS_GetBaseMsg) Serialize(w io.Writer) error {
	return writeWMLS_GetBaseMsg(r, w)
}
